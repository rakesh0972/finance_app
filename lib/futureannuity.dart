...
class futureannuity extends StatefulWidget {
  @override
  State<futureannuity> createState() => _presentState();
}

class _presentState extends State<futureannuity> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: show
                ? Center(
                    child: Text(
                      'The Future Value of Annuity is $res',
                      style: TextStyle(
                        fontFamily: 'poppins',
                        fontSize: 30,
